...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateUi(
        ...
        if (active) {
            ...
            detailText.text =
                "Adult DNS filtering فعال ہے۔ باقی internet traffic VPN tunnel میں نہیں جاتا۔"
            ...
            statusText.text =
                message ?: "حفاظت غیر فعال ہے"

            detailText.text =
                "Protection شروع کرنے کے لیے نیچے بٹن دبائیں۔"
